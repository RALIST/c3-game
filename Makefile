build: assets
	c3c compile -D PLATFORM_WEB --memory-env=normal --reloc=none --trust=full --target wasm32 -O5 --link-libc=no --no-entry -z --export-table -z --allow-undefined -o main main.c3 assets.c3
